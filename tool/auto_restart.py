#!/usr/bin/env python
#coding=utf-8
# crontab config: * * * * * root python /opt/note/tool/auto_restart.py 4
import os
import sys
import traceback
from datetime import datetime
ERROR_LOG = '/opt/note/log/auto_restart'
PID_FILE  = '/var/run/note-master-spawn-fcgi.pid'
